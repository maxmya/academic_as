...
INSERT INTO `admin` VALUES (8,34),(9,39),(10,40);
...
CREATE TABLE `auth_group` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `auth_group` varchar(150) DEFAULT NULL,
  `username` varchar(150) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `table_name_user_username_fk` (`username`),
  CONSTRAINT `table_name_user_username_fk` FOREIGN KEY (`username`) REFERENCES `user` (`username`)
...
INSERT INTO `auth_group` VALUES (2,'ADMIN','oa'),(3,'STUDENT','oo');
...
INSERT INTO `course` VALUES (3,'general math','22244',8,32,3),(4,'general math2','math 1031',8,0,3),(5,'a math','matha 101',8,0,3),(7,'a math','matha2 22',8,0,3),(8,'math1','131',8,3,3),(9,'','21',8,2,3),(10,'test2','88888888',8,8,8),(12,'test1','8',8,8,8),(14,'','19',8,3,3),(15,'','1',8,12,21),(17,'test3','2333',8,12,21),(18,'','',8,3,33),(21,'test','10',8,1,2),(22,'test2','101',8,1,2),(24,'ww','22',8,22,22),(25,'sa','20',8,10,10),(27,'sasad','202',8,10,10),(28,'','3434',8,3,3),(35,'omar wael','123',8,3,3),(37,'Test Course','1239',8,50,90),(40,'test111','1111111111',8,2,2),(42,'math','1312222',12,3,3);
...
--
-- Table structure for table `course_student_degrees`
--

DROP TABLE IF EXISTS `course_student_degrees`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `course_student_degrees` (
  `degree_id` int(11) NOT NULL,
  `course_instance_id` int(11) NOT NULL,
  `student_id` int(11) NOT NULL,
  `id` int(11) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`id`),
  KEY `course_student_degrees_registration info_id_fk` (`degree_id`),
  KEY `course_student_degrees_course_instance_id_fk` (`course_instance_id`),
  KEY `course_student_degrees_student_id_fk` (`student_id`),
  CONSTRAINT `course_student_degrees_course_instance_id_fk` FOREIGN KEY (`course_instance_id`) REFERENCES `course_instance` (`id`),
  CONSTRAINT `course_student_degrees_registration info_id_fk` FOREIGN KEY (`degree_id`) REFERENCES `registration_info` (`id`),
  CONSTRAINT `course_student_degrees_student_id_fk` FOREIGN KEY (`student_id`) REFERENCES `student` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `course_student_degrees`
--

LOCK TABLES `course_student_degrees` WRITE;
/*!40000 ALTER TABLE `course_student_degrees` DISABLE KEYS */;
/*!40000 ALTER TABLE `course_student_degrees` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `department` VALUES (9,'computer science'),(12,'cumesitry'),(10,'ss'),(8,'test');
...
INSERT INTO `instructor` VALUES (1,31),(2,32),(3,35),(4,42);
...
INSERT INTO `student` VALUES (4,36,0,1),(5,37,0,1),(6,40,0,1);
...
INSERT INTO `user` VALUES (31,'mohanad','adel','3mohanad_admin@as.com','$2a$10$2NpWfWvIny7kD/pZbDvCzei6pOpcsB8gihs6CnADmUAEC8Zad7aEq','mohnad_admin3','2018-09-19'),(32,'mohanad','adel','3mohanad_a1dmin@as.com','$2a$10$Rw0okgDfZ2ydfr1wj3UL6ufIc9PfWQKNRJkwUnoCpGEmWyB7afN7K','mohnad_1admin3','2018-09-19'),(34,'omar1','wael1','3mohanad_a1edmin@as.com','$2a$10$aQlgb43QkdC8XLoBSGBNT.5s4/07Z.syEjZKNM7ydoLtuewHYV7xa','oo1',NULL),(35,'mohanad','adel','3mohanad_a1e32dmin@as.com','$2a$10$aQlgb43QkdC8XLoBSGBNT.5s4/07Z.syEjZKNM7ydoLtuewHYV7xa','instructor','2018-09-19'),(36,'mahmoud','aref','aref@as.com','$2a$10$l.I7eTrfQiK54WEO3FHYFudx2lJxvT4r.67Y5HiudLhhcS5dF.4TO','aref','2018-09-20'),(37,'Ahmed','Shawki','test2@m.com','$2a$10$Dju6azK53BnAcY5mcqVEeOej2fJSkDpnbqX5LLzOwL20P.hqQZ4o2','shawki','2018-10-03'),(38,'omar','wael','a@ex.com','$2a$10$8v2hNvW58lp78CwZr65ML.h4chmviRE/K2rA4uKyagYS1qXpf4Cjm','o','2018-10-24'),(39,'omar121','wael111','omar_wael1890@yahoo.com','$2a$10$aQlgb43QkdC8XLoBSGBNT.5s4/07Z.syEjZKNM7ydoLtuewHYV7xa','oa',NULL),(40,'omar1','wael1','omar1234@example.com','$2a$10$aQlgb43QkdC8XLoBSGBNT.5s4/07Z.syEjZKNM7ydoLtuewHYV7xa','oo',NULL),(42,'s','s','s@example.com','$2a$10$aQlgb43QkdC8XLoBSGBNT.5s4/07Z.syEjZKNM7ydoLtuewHYV7xa','is','2018-11-28');
...
-- Dump completed on 2018-11-30 21:39:28
